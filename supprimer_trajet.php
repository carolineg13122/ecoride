...
if (!isset($_SESSION['user_id'])) {
    header("Location: connexion.php?message=Connectez-vous pour annuler un trajet.");
    exit();
}
...
try {
    ...
    header("Location: mes_trajets.php?message=Trajet annulé avec succès. Les passagers ont été remboursés et informés.");
    exit();
