...
<head>
    <meta charset="UTF-8">
    <title>Signalements passagers</title>
...
<?php foreach ($signalements as $s): ?>
    ...
    <!-- Créditer quand même -->
    <form action="traiter_signalement.php" method="POST">
    ...
    <!-- Ne pas créditer -->
    <form action="traiter_signalement.php" method="POST" onsubmit="return confirm('Confirmer que le chauffeur ne sera pas crédité ?');">
        <input type="hidden" name="confirmation_id" value="<?= $s['id'] ?>">
