...
if (!isset($_SESSION['user_id'])) {
    header("Location: connexion.php?message=Connectez-vous pour laisser un avis.");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$note || $note < 1 || $note > 5) {
        ...
        header("Location: mes_reservations.php?message=Avis envoyé et en attente de validation.");
        exit();
    }
}
?>
