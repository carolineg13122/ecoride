...
if (!isset($_SESSION['user_id'])) {
    header("Location: ../controllers/connexion.php?message=Connectez-vous pour annuler une réservation.");
    exit();
}
...
try {
    ...
    header("Location: ../views/mes_reservations.php?message=Réservation annulée.");
    exit();
