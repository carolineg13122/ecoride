...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$user || $user['credits'] < 2) {
        header("Location: ../views/mes_trajets.php?message=Vous n'avez pas assez de crédits pour publier un trajet.");
        exit();
    }
    ...
    header("Location: ../views/mes_trajets.php?message=Trajet publié avec succès !");
    exit();
} else {
